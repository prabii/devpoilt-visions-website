...
const TeamMemberCard = ({ member }: { member: TeamMember }) => {
  return (
    <div 
      className="group glass-card p-6 text-center animate-fade-in" 
      style={{ animationDelay: `${member.id * 100}ms` }}
    >
      <div className="relative mb-6 mx-auto w-32 h-32 rounded-full overflow-hidden border-2 border-primary/20 p-1">
        <img 
          src={member.image} 
          alt={member.name} 
...
const TeamSection = () => {
  const team: TeamMember[] = [
    ...
    },
    {
      ...
      bio: "Building scalable cloud infrastructure that handles millions of users effortlessly.",
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '200ms' }}>
            Our team of experts brings together years of experience across various domains of technology.
          </p>
        </div>
